...
<link
	...
	rel="stylesheet">
<link rel="stylesheet" href="/layout/scrollPage.css">
			...
			<div class="container-fluid">
				<div class="row mt-5 p-5 gx-5">
					<div class="col-3">
						...
						<div class="card p-1">
							<form action="/home/mon" method="post" class="mb-3">
								<p>Tìm kiếm theo giá tiền:</p><br>
								<label for="so1" value="${param.min}" class="form-label">Từ:</label>
								<input name="min" value="${param.max}" type="number" class="form-control"> <br>
								<label for="so1" class="form-label">Đến:</label> 
								<input name="max" type="number" class="form-control"> <br>
